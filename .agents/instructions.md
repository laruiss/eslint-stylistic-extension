# AI Coding Instructions for eslint-stylistic-extension

## Project overview

`eslint-stylistic-extension` is a TypeScript package published on the npm registry as `@laruiss/eslint-stylistic-extension`, providing an ESLint plugin.
